...
client_sources = client.cpp tcp_socket.cpp au_stream_socket.cpp common.cpp protocol.cpp opcode.cpp
client32_objects = $(client_sources:.cpp=.o_32)
client64_objects = $(client_sources:.cpp=.o_64)

server_sources = server.cpp tcp_socket.cpp au_stream_socket.cpp common.cpp protocol.cpp calc.cpp opcode.cpp
server_objects = $(server_sources:.cpp=.o_64)

test_sources = tcp_socket.cpp au_stream_socket.cpp test.cpp common.cpp
